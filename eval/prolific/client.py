...
class ProlificStudyManager:
    """Manager for World Model Evaluation studies on Prolific."""
    ...
    def create_evaluation_study(
        ...
        """
        Create a World Model Evaluation study.
        ...
        # Study description
        description = f"""
        Evaluate AI-generated world models by comparing pairs of videos.
        ...
        study = self.client.create_study(
            name=f"World Model Evaluation: {study_name}",
