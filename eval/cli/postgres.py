...
def status():
    ...
    try:
        ...
        with conn.cursor(cursor_factory=RealDictCursor) as cursor:
            ...
            if table_stats:
                click.echo("\n📈 Table Statistics:")
                stats_data = [[t['tablename'], t['inserts'], t['updates'], t['deletes']] for t in table_stats]
                click.echo(tabulate(stats_data, headers=['Table', 'Inserts', 'Updates', 'Deletes'], tablefmt='grid'))
